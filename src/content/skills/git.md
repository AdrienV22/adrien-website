...
evidence:
  - title: "Versionning sur projets full-stack et portfolio"
    context: "Projet Application de gestion de projet et Portfolio Astro – suivi des livrables et déploiements."
    result: "Historique clair, commits structurés, capacité à revenir en arrière et à documenter les évolutions."
  - title: "Pratique Git en contexte professionnel (RPA, ETL)"
    context: "Alternance – projets d’automatisation et de flux de données."
    result: "Travail en branches, revues informelles, intégration dans une chaîne de livraison."

selfCritique: >
  Niveau 7/10. Git est un outil quotidien dans tous mes projets. Je suis à l’aise avec les branches,
  les merges, le rebase et la résolution de conflits. Je souhaite approfondir les workflows avancés
  (Git flow, conventions de commit plus strictes) et l’intégration avec la CI/CD.
...
relatedWorks: ["portfolio", "etl", "application-gestion-de-projet"]
---
